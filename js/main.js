...
let shakeBtn = document.getElementById("shakes");
...
breakBtn.addEventListener("click", () => {
  sectionCenter.innerHTML = null;
  let newArr = menu.filter((element) =>
    element.category == breakBtn.value ? element : null
  );
  render(newArr);
});
lunchBtn.addEventListener("click", () => {
  sectionCenter.innerHTML = null;
  let newArr = menu.filter((element) =>
    element.category == lunchBtn.value ? element : null
  );
  render(newArr);
});
shakeBtn.addEventListener("click", () => {
  sectionCenter.innerHTML = null;
  let newArr = menu.filter((element) =>
    element.category == shakeBtn.value ? element : null
  );
  render(newArr);
});
